# Omit and pick
## Omit
- Criar novos tipos a partir de outros omitindo algumas propriedades.
...
```
- Muito não?
- Se percebe que `owner` no `GithubRepoResponse` é praticamente o `GithubUserResponse` sem algumas propriedades, podemos defini-lo asssim:
```ts
...
```
ou seja:
tipo: `Omit<tipoOriginal, 'propriedade1' | 'propriedade2' ... >`

## Pick
- You pick the properties.
