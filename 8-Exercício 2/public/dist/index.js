...
function askPlanet() {
    ...
    const coordinates = [cood1, cood2, cood3, cood4];
    let ok = 0;
    let situation;
    do {
...
function findPlanet(name) {
    ...
    return planet !== null && planet !== void 0 ? planet : false; // "??" siginifica que caso seja nulo será retornado false
}
...
function removeSatelite(satellite, planet) {
